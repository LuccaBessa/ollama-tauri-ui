...
export default function SettingsAboutPage(): JSX.Element {
  return (
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  ...
                  href="https://github.com/LuccaBessa/ollama-tauri-ui"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  className={buttonVariants({ variant: 'ghost', size: 'icon' })}
                  href="https://github.com/LuccaBessa/ollama-tauri-ui/issues/new"
                  target="_blank"
                  rel="noreferrer"
                >
